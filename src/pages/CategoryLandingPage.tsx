...
export default function CategoryLandingPage() {
  ...
  // Format the name nicely if from URL (e.g., paints -> Paints)
  const category = categoryName ? categoryName.charAt(0).toUpperCase() + categoryName.slice(1) : "Category";

  const handleSelectSubcategory = (subcat: string) => {
    navigate(`/search?category=${encodeURIComponent(subcat)}`);
  };
    ...
    <div className="w-full bg-white pb-16 animate-fade-in">
      ...
      <div className="border-b border-zinc-100 bg-zinc-50 py-3">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center text-xs font-bold text-zinc-500 uppercase tracking-wider">
          <Link to="/" className="hover:text-[#E31B23] cursor-pointer">Home</Link>
